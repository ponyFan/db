layui.define(['element'], function (exports) {
    ...
    function _CustomRightClick(rightMenuConfig) {
        ...
        $("#" + rightmenuObj.filter).on('contextmenu', 'li', function (e) {
            ...
            var leftValue =(($(window).width())/2) > e.clientX ? ((($("#" + rightmenuObj.filter).width())/2) - ((($(window).width())/2)-e.clientX)) : ((($("#" + rightmenuObj.filter).width())/2) + (e.clientX-(($(window).width())/2)));
            var topValue = e.offsetY + 20;
